...
declare -A time=(["bert-base-uncased"]="02:20:00" ["albert-base-v2"]="02:20:00" ["roberta-base"]="02:20:00" ["gpt2"]="02:20:00")

for model in ${masked_lm_quant_models[@]}; do
  for quant_type in "dynamic"; do
    for quant_prec in "int8"; do
      experiment_id="stereoset_m-${model}_c-${model_to_quantbasemodel_name_or_path[${model}]}_qt-${quant_type}_qp-${quant_prec}"
